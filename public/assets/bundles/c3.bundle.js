(!(function (a, b) {
    ...
    function a(a, b) {
        ...
        ((c.component = a),
            (c.params = b || {}),
            (c.d3 = a.d3),
            (c.scale = c.d3.scale.linear()),
            c.range,
            (c.orient = "bottom"),
            (c.innerTickSize = 6),
            (c.outerTickSize = this.params.withOuterTick ? 6 : 0),
            (c.tickPadding = 3),
            (c.tickValues = null),
            c.tickFormat,
            c.tickArguments,
            ...
            c.tickCentered,
            c.tickTextCharSize,
            (c.tickTextRotate = c.params.tickTextRotate),
            c.tickLength,
            (c.axis = c.generateAxis()));
    }
    function b(a) {
        ...
        (b.loadConfig(a),
            ...
            (function a(b, c, d) {
                Object.keys(b).forEach(function (e) {
                    ((c[e] = b[e].bind(d)),
                        Object.keys(b[e]).length > 0 && a(b[e], c[e], d));
                });
            })(A, this, this));
    }
    function c(a) {
    ...
    (((e = a.prototype).axisX = function (a, b, c) {
        ...
        (e.generateTicks = function (a) {
            ...
            return (
                e.length > 0 && e[0] > 0 && e.unshift(e[0] - (e[1] - e[0])),
                e
            );
        }),
        (e.copyScale = function () {
            ...
            return (
                b.params.isCategory &&
                    ((a = b.scale.domain()), c.domain([a[0], a[1] - 1])),
                c
            );
        }),
        ...
        (e.updateRange = function () {
            var a = this;
            return (
                (a.range = a.scale.rangeExtent
                    ? a.scale.rangeExtent()
                    : a.scaleExtent(a.scale.range())),
                a.range
            );
        }),
        ...
        (e.tspanData = function (a, b, c, d) {
            var e = this,
                f = e.params.tickMultiline
                    ? e.splitTickText(a, c, d)
                    : [].concat(e.textFormatted(a));
            return f.map(function (a) {
                return { index: b, splitted: a, length: f.length };
            });
        }),
            ...
            function d(a, b) {
                ...
                for (var c = 1; c < b.length; c++)
                    if (
                        (" " === b.charAt(c) && (f = c),
                        (e = b.substr(0, c + 1)),
                        (g = h.tickTextCharSize.w * e.length),
                        j < g)
                    )
                        return d(
                            a.concat(b.substr(0, f || c)),
                            b.slice(f ? f + 1 : c),
                        );
                return a.concat(b);
            }
        ...
        (e.tspanDy = function (a, b) {
            ...
            return (
                0 === b &&
                    (d = c.isVertical()
                        ? -((a.length - 1) * (c.tickTextCharSize.h / 2) - 3)
                        : ".71em"),
                d
            );
        }),
        (e.generateAxis = function () {
            function a(e) {
                e.each(function () {
                    ...
                    (d.isCategory
                        ? ((b.tickOffset = Math.ceil((j(1) - j(0)) / 2)),
                          (f = b.tickCentered ? 0 : b.tickOffset),
                          (g = b.tickCentered ? b.tickOffset : 0))
                        : (b.tickOffset = f = 0),
                        m.append("line"),
                        m.append("text"),
                        b.updateRange(),
                        b.updateTickLength(),
                        b.updateTickTextCharSize(h.select(".tick")));
                    var p = o.select("line"),
                        q = o.select("text"),
                        r = l
                            .select("text")
                    ...
                    switch (b.orient) {
                        ...
                        case "top":
                            ((e = b.axisX),
                                p.attr("x2", 0).attr("y2", -b.innerTickSize),
                                q
                                    .attr("x", 0)
                                    .attr("y", -b.tickLength)
                                    .style("text-anchor", "middle"),
                                r.attr("x", 0).attr("dy", "0em"),
                                t.attr(
                                    "d",
                                    "M" +
                                        b.range[0] +
                        ...
                        case "right":
                            ((e = b.axisY),
                                p.attr("x2", b.innerTickSize).attr("y2", 0),
                                q
                                    .attr("x", b.tickLength)
                                    .attr("y", 0)
            ...
            return (
                ...
                (a.orient = function (c) {
                    return arguments.length
                        ? ((b.orient =
                              c in { top: 1, right: 1, bottom: 1, left: 1 }
                                  ? c + ""
                                  : "bottom"),
                          a)
                        : b.orient;
    ...
    (((d = z.prototype).init = function () {
        ...
        (d.getXAxis = function (a, b, c, d, e, f, g) {
            ...
            return (
                ...
                k.tickFormat(c).tickValues(d),
                h.isCategorized() &&
                    (k.tickCentered(i.axis_x_tick_centered),
                    t(i.axis_x_tick_culling) && (i.axis_x_tick_culling = !1)),
                k
            );
        }),
        ...
        (d.getYAxis = function (a, b, c, d, e, f, g) {
            var h = this.owner,
                ...
                k = new this.internal(this, j).axis
                    .scale(a)
                    .orient(b)
                    .tickFormat(c);
            return (
                h.isTimeSeriesY()
                    ? k.ticks(
                          h.d3.time[i.axis_y_tick_time_value],
                          i.axis_y_tick_time_interval,
                      )
                    : k.tickValues(d),
                k
            );
        ...
        (d.getMaxTickWidth = function (a, b) {
            var c,
                ...
                h = g.config,
                i = 0;
            return b && g.currentMaxTickWidths[a]
                ? g.currentMaxTickWidths[a]
                : (g.svg &&
                      ((c = g.filterTargetsToShow(g.data.targets)),
                      "y" === a
                          ? ((d = g.y.copy().domain(g.getYDomain(c, "y"))),
                            (e = this.getYAxis(
                                d,
                                g.yOrient,
                          ...
                          : "y2" === a
                            ? ((d = g.y2.copy().domain(g.getYDomain(c, "y2"))),
                              (e = this.getYAxis(
                                  d,
                                  g.y2Orient,
                                  h.axis_y2_tick_format,
                                  g.y2AxisTickValues,
                                  !1,
                                  !0,
                                  !0,
                              )))
                            : ((d = g.x.copy().domain(g.getXDomain(c))),
                              (e = this.getXAxis(
                                  d,
                                  g.xOrient,
                                  g.xAxisTickFormat,
                      ...
                      (f = g.d3.select("body").append("div").classed("c3", !0))
                          .append("svg")
                  ...
                  (g.currentMaxTickWidths[a] =
                      i <= 0 ? g.currentMaxTickWidths[a] : i),
                  g.currentMaxTickWidths[a]);
        }),
    ...
    var A,
        ...
        C = { version: "0.4.18" };
    return (
        (C.generate = function (a) {
            return new b(a);
        }),
        (C.chart = { fn: b.prototype, internal: { fn: c.prototype } }),
        (A = C.chart.fn),
        (B = C.chart.internal.fn),
        (B.beforeInit = function () {}),
        (B.afterInit = function () {}),
        (B.init = function () {
            var a = this,
                b = a.config;
        ...
        (B.initWithData = function (a) {
            ...
            ((d.axis = new z(d)),
                ...
                d.initChartElements(),
                c
                    .insert("rect", g.zoom_privileged ? null : "g." + f.regions)
                    .attr("class", f.zoomRect)
                    .attr("width", d.width)
        ...
        (B.redraw = function (a, b) {
            ...
            if (
                ((a = a || {}),
                (c = v(a, "withY", !0)),
                (d = v(a, "withSubchart", !0)),
                (e = v(a, "withTransition", !0)),
                (i = v(a, "withTransform", !1)),
                (j = v(a, "withUpdateXDomain", !1)),
                (k = v(a, "withUpdateOrgXDomain", !1)),
                (l = v(a, "withTrimXDomain", !0)),
                (p = v(a, "withUpdateXAxis", j)),
                (m = v(a, "withLegend", !1)),
                (n = v(a, "withEventRect", !0)),
                (o = v(a, "withDimension", !0)),
                (g = v(a, "withTransitionForExit", e)),
                (h = v(a, "withTransitionForAxis", e)),
            ...
            ((q = H.generateDrawArea ? H.generateDrawArea(L, !1) : void 0),
                ...
                H.redrawArc && H.redrawArc(w, x, i),
                H.redrawSubchart && H.redrawSubchart(d, b, w, x, L, M, N),
                I.selectAll("." + f.selectedCircles)
        ...
        (B.updateAndRedraw = function (a) {
            var b,
                c = this,
                d = c.config;
            (((a = a || {}).withTransition = v(a, "withTransition", !0)),
                (a.withTransform = v(a, "withTransform", !1)),
                (a.withLegend = v(a, "withLegend", !1)),
                (a.withUpdateXDomain = !0),
                (a.withUpdateOrgXDomain = !0),
                (a.withTransitionForExit = !1),
                (a.withTransitionForTransform = v(
                    a,
        ...
        (B.getTranslate = function (a) {
            ...
            return (
                "main" === a
                    ? ((b = r(d.margin.left)), (c = r(d.margin.top)))
                    : "context" === a
                      ? ((b = r(d.margin2.left)), (c = r(d.margin2.top)))
                      : "legend" === a
        ...
        (B.opacityForCircle = function (a) {
            var b = (
                l(this.config.point_show)
                    ? this.config.point_show(a)
                    : this.config.point_show
            )
                ? 1
                : 0;
            return k(a.value) ? (this.isScatterType(a) ? 0.5 : b) : 0;
        }),
        ...
        (B.transformMain = function (a, b) {
            ...
            (b && b.axisX
                ? (c = b.axisX)
                : ((c = g.main.select("." + f.axisX)),
                  a && (c = c.transition())),
                b && b.axisY
                    ? (d = b.axisY)
                    : ((d = g.main.select("." + f.axisY)),
                      a && (d = d.transition())),
                b && b.axisY2
                    ? (e = b.axisY2)
                    : ((e = g.main.select("." + f.axisY2)),
                      a && (e = e.transition())),
                (a ? g.main.transition() : g.main).attr(
                    "transform",
                    g.getTranslate("main"),
                ),
                c.attr("transform", g.getTranslate("x")),
                d.attr("transform", g.getTranslate("y")),
                e.attr("transform", g.getTranslate("y2")),
                g.main
                    .select("." + f.chartArcs)
                    .attr("transform", g.getTranslate("arc")));
        }),
        ...
        (B.observeInserted = function (a) {
            ...
            "undefined" != typeof MutationObserver
                ? (b = new MutationObserver(function (d) {
                      d.forEach(function (d) {
                          "childList" === d.type &&
                              d.previousSibling &&
                              (b.disconnect(),
                              (c.intervalForObserveInserted =
        ...
        (B.bindResize = function () {
            var a = this,
                b = a.config;
            if (
                ((a.resizeFunction = a.generateResize()),
                a.resizeFunction.add(function () {
                    b.onresize.call(a);
                }),
                b.resize_auto &&
                    a.resizeFunction.add(function () {
                        (void 0 !== a.resizeTimeout &&
                            window.clearTimeout(a.resizeTimeout),
                            (a.resizeTimeout = window.setTimeout(function () {
                ...
                window.attachEvent("onresize", a.resizeFunction);
            else if (window.addEventListener)
                window.addEventListener("resize", a.resizeFunction, !1);
            else {
                var c = window.onresize;
                (c
                    ? (c.add && c.remove) ||
                      (c = a.generateResize()).add(window.onresize)
                    : (c = a.generateResize()),
                    c.add(a.resizeFunction),
                    (window.onresize = c));
            }
        }),
        ...
        (B.parseDate = function (a) {
            ...
            return (
                a instanceof Date
                    ? (b = a)
                    : "string" == typeof a
                      ? (b = c.dataTimeFormat(c.config.data_xFormat).parse(a))
                      : "object" === (void 0 === a ? "undefined" : g(a))
                        ? (b = new Date(+a))
                        : "number" != typeof a ||
                          isNaN(a) ||
                ...
                (b && !isNaN(+b)) ||
                    window.console.error(
                        "Failed to parse x '" + a + "' to Date object",
                    ),
                b
            );
        }),
        ...
        "SVGPathSeg" in window ||
            ((window.SVGPathSeg = function (a, b, c) {
                ((this.pathSegType = a),
                ...
                ((d.prototype._isCurrentSpace = function () {
                    ...
                    (d.prototype._nextCommandHelper = function (a, b) {
                        return ("+" == a ||
                            ...
                            "." == a ||
                            (a >= "0" && a <= "9")) &&
                            b != window.SVGPathSeg.PATHSEG_CLOSEPATH
                            ? b == window.SVGPathSeg.PATHSEG_MOVETO_ABS
                                ? window.SVGPathSeg.PATHSEG_LINETO_ABS
                                : b == window.SVGPathSeg.PATHSEG_MOVETO_REL
                                  ? window.SVGPathSeg.PATHSEG_LINETO_REL
                                  : b
                            : window.SVGPathSeg.PATHSEG_UNKNOWN;
                    }),
                    ...
                    (d.prototype._parseNumber = function () {
                        ...
                        if (
                            ...
                            if (this._currentIndex != h)
                                for (
                                    var i = this._currentIndex - 1, j = 1;
                                    i >= h;
                                )
                                    ((b +=
                                        j * (this._string.charAt(i--) - "0")),
                                        (j *= 10));
                            if (
                                this._currentIndex < this._endIndex &&
                                "." == this._string.charAt(this._currentIndex)
        ...
        (A.axis.max = function (a) {
            var b = this.internal,
                c = b.config;
            if (!arguments.length)
                return { x: c.axis_x_max, y: c.axis_y_max, y2: c.axis_y2_max };
            ("object" === (void 0 === a ? "undefined" : g(a))
                ? (k(a.x) && (c.axis_x_max = a.x),
                  k(a.y) && (c.axis_y_max = a.y),
                  k(a.y2) && (c.axis_y2_max = a.y2))
        ...
        (A.axis.min = function (a) {
            var b = this.internal,
                c = b.config;
            if (!arguments.length)
                return { x: c.axis_x_min, y: c.axis_y_min, y2: c.axis_y2_min };
            ("object" === (void 0 === a ? "undefined" : g(a))
                ? (k(a.x) && (c.axis_x_min = a.x),
                  k(a.y) && (c.axis_y_min = a.y),
                  k(a.y2) && (c.axis_y2_min = a.y2))
        ...
        (A.axis.range = function (a) {
            ...
            (void 0 !== a.max && this.axis.max(a.max),
                void 0 !== a.min && this.axis.min(a.min));
        }),
        ...
        (A.resize = function (a) {
            ...
            ((b.size_width = a ? a.width : null),
                (b.size_height = a ? a.height : null),
                this.flush());
        }),
        (A.flush = function () {
        ...
        (A.destroy = function () {
            var a = this.internal;
            if (
                (window.clearInterval(a.intervalForObserveInserted),
                void 0 !== a.resizeTimeout &&
                    window.clearTimeout(a.resizeTimeout),
                window.detachEvent)
            )
                window.detachEvent("onresize", a.resizeFunction);
            else if (window.removeEventListener)
                window.removeEventListener("resize", a.resizeFunction);
            else {
                var b = window.onresize;
                b && b.add && b.remove && b.remove(a.resizeFunction);
            }
            return (
                a.selectChart.classed("c3", !1).html(""),
            ...
            ((b = i.convertDataToTargets(c, !0)),
                ...
                i.data.targets.forEach(function (a) {
                    ...
                    for (b = 0; b < j.length; b++)
                        if (a.id === j[b])
                            for (
                                n = a.values[a.values.length - 1].index + 1,
                                    c = 0;
                                c < m;
                                c++
                            )
                                a.values.push({
                                    ...
                                    index: n + c,
                                    x: i.isTimeSeries()
                                        ? i.getOtherTargetX(n + c)
                                        : n + c,
                                    value: null,
                                });
                }),
                i.data.targets.length &&
                    b.forEach(function (a) {
                        var b,
                            c = [];
                        for (b = i.data.targets[0].values[0].index; b < n; b++)
                            c.push({
                                id: a.id,
                                index: b,
                ...
                (i.data.targets = i.data.targets.concat(b)),
                i.getMaxDataCount(),
                (f = (e = i.data.targets[0]).values[0]),
                void 0 !== a.to
                    ? ((m = 0),
                      (h = i.isTimeSeries() ? i.parseDate(a.to) : a.to),
                      e.values.forEach(function (a) {
                          a.x < h && m++;
                      }))
                    : void 0 !== a.length && (m = a.length),
                l
                    ? 1 === l &&
                      i.isTimeSeries() &&
                      ((g = (e.values[e.values.length - 1].x - f.x) / 2),
                      (d = [new Date(+f.x - g), new Date(+f.x + g)]),
                      i.updateXDomain(null, !0, !0, !1, d))
                    : ((g = i.isTimeSeries()
                          ? e.values.length > 1
                              ? e.values[e.values.length - 1].x - f.x
                              : f.x - i.getXDomain(i.data.targets)[0]
                          : 1),
                      (d = [f.x - g, f.x]),
                      i.updateXDomain(null, !0, !0, !1, d)),
        ...
        (B.generateFlow = function (a) {
            ...
            return function () {
                ...
                ((b.flowing = !0),
                    ...
                    (h = b.updateXDomain(i, !0, !0)),
                    b.updateXGrid && b.updateXGrid(!0),
                    j.orgDataCount
                        ? (e =
                              1 === j.orgDataCount || (x && x.x) === (y && y.x)
                                  ? b.x(z[0]) - b.x(h[0])
                                  : b.isTimeSeries()
                                    ? b.x(z[0]) - b.x(h[0])
                                    : b.x(x.x) - b.x(y.x))
                    ...
                    d
                        ...
                        .each(function () {
                            (C.add(b.axes.x.transition().call(b.xAxis)),
                                C.add(H.transition().attr("transform", g)),
                                C.add(I.transition().attr("transform", g)),
                                C.add(J.transition().attr("transform", g)),
                                C.add(K.transition().attr("transform", g)),
                                C.add(G.transition().attr("transform", g)),
                                C.add(
                                    F.filter(b.isRegionOnX)
                                        .transition()
                                        .attr("transform", g),
                                ),
                                C.add(D.transition().attr("transform", g)),
                                C.add(E.transition().attr("transform", g)));
                        })
                        .call(C, function () {
                            var a,
                                d = [],
                            ...
                            if (w) {
                                ...
                                (b.svg
                                    ...
                                    b.svg
                                        ...
                                        .remove(),
                                    b.svg
                                        .selectAll("." + f.eventRects)
                                        .selectAll(g)
                                        .remove(),
                                    b.svg.select("." + f.xgrid).remove());
                            }
        ...
        (A.focus = function (a) {
            ...
            ((a = c.mapToTargetIds(a)),
                ...
                this.revert(),
                this.defocus(),
                b.classed(f.focused, !0).classed(f.defocused, !1),
                c.hasArcType() && c.expandArc(a),
                c.toggleFocusLegend(a, !0),
                (c.focusedTargetIds = a),
                (c.defocusedTargetIds = c.defocusedTargetIds.filter(
                    function (b) {
        ...
        (A.defocus = function (a) {
            ...
            ((a = b.mapToTargetIds(a)),
                b.svg
                    .selectAll(b.selectorTargets(a.filter(b.isTargetToShow, b)))
                    .classed(f.focused, !1)
                    .classed(f.defocused, !0),
                b.hasArcType() && b.unexpandArc(a),
                b.toggleFocusLegend(a, !1),
                (b.focusedTargetIds = b.focusedTargetIds.filter(function (b) {
                    return a.indexOf(b) < 0;
                })),
        ...
        (A.revert = function (a) {
            ...
            ((a = b.mapToTargetIds(a)),
                b.svg
                    .selectAll(b.selectorTargets(a))
                    .classed(f.focused, !1)
                    .classed(f.defocused, !1),
                b.hasArcType() && b.unexpandArc(a),
                b.config.legend_show &&
                    (b.showLegend(a.filter(b.isLegendToShow.bind(b))),
                    b.legend
                        ...
                        .classed(f.legendItemFocused, !1)),
                (b.focusedTargetIds = []),
                (b.defocusedTargetIds = []));
        }),
        (A.xgrids = function (a) {
            var b = this.internal,
                c = b.config;
        ...
        (A.load = function (a) {
            var b = this.internal,
                c = b.config;
            (a.xs && b.addXs(a.xs),
                "names" in a && A.data.names.bind(this)(a.names),
                "classes" in a &&
                ...
                "cacheIds" in a && b.hasCaches(a.cacheIds)
                    ? b.load(b.getCaches(a.cacheIds), a.done)
                    : "unload" in a
                      ? b.unload(
                            b.mapToTargetIds(
        ...
        (A.regions.remove = function (a) {
            ...
            return (
                (a = a || {}),
                (b = e.getOption(a, "duration", g.transition_duration)),
                (c = e.getOption(a, "classes", [f.region])),
                (d = e.main.select("." + f.regions).selectAll(
                    c.map(function (a) {
                        return "." + a;
                    }),
                )),
                (b ? d.transition().duration(b) : d)
                    .style("opacity", 0)
                    .remove(),
                (g.regions = g.regions.filter(function (a) {
                    var b = !1;
                    return (
                        !a.class ||
        ...
        (A.selected = function (a) {
            ...
            return c.merge(
                b.main
                    .selectAll("." + f.shapes + b.getTargetSelectorSuffix(a))
                    .selectAll("." + f.shape)
                    .filter(function () {
                ...
                d.main
                    ...
                    .each(function (h, i) {
                        ...
                        j.classed(f.line) ||
                            j.classed(f.area) ||
                            (m && n
                                ? g.data_selection_isselectable(h) &&
                                  !o &&
                                  l(!0, j.classed(f.SELECTED, !0), h, i)
                                : void 0 !== c &&
                                  c &&
                                  o &&
                                  l(!1, j.classed(f.SELECTED, !1), h, i));
                    });
        }),
                ...
                c.main
                    ...
                    .each(function (g, h) {
                        ...
                        i.classed(f.line) ||
                            ...
                            (l &&
                                m &&
                                e.data_selection_isselectable(g) &&
                                n &&
                                k(!1, i.classed(f.SELECTED, !1), g, h));
                    });
        }),
        (A.show = function (a, b) {
            var c,
        ...
        (A.zoom.range = function (a) {
            ...
            (void 0 !== a.max && this.domain.max(a.max),
                void 0 !== a.min && this.domain.min(a.min));
        }),
        (B.initPie = function () {
            var a = this,
                b = a.d3;
        ...
        (B.getSvgArcExpanded = function (a) {
            var b = this,
                c = b.d3.svg
                    .arc()
                    .outerRadius(b.radiusExpanded * (a || 1))
            ...
            c.transiting
                ? (b = window.setInterval(function () {
                      c.transiting ||
                          ...
                          c.legend.selectAll(".c3-legend-item-focused").size() >
                              0 && c.expandArc(a));
                  }, 10))
                : ((a = c.mapToTargetIds(a)),
                  c.svg
                      .selectAll(c.selectorTargets(a, "." + f.chartArc))
                      .each(function (a) {
                          c.shouldExpand(a.data.id) &&
                              c.d3
                                  .select(this)
                                  .selectAll("path")
                                  .transition()
                                  .duration(c.expandDuration(a.data.id))
                                  .attr("d", c.svgArcExpanded)
                                  .transition()
                                  .duration(2 * c.expandDuration(a.data.id))
                                  .attr("d", c.svgArcExpandedSub)
                                  .each(function (a) {
        ...
        (B.unexpandArc = function (a) {
            ...
            b.transiting ||
                ((a = b.mapToTargetIds(a)),
                b.svg
                    .selectAll(b.selectorTargets(a, "." + f.chartArc))
                    .selectAll("path")
                    .transition()
                    .duration(function (a) {
        ...
        (B.updateTargetsForArc = function (a) {
            ...
            ((b = d
                ...
                b
                    .append("text")
                    .attr("dy", c.hasType("gauge") ? "-.1em" : ".35em")
                    .style("opacity", 0)
                    .style("text-anchor", "middle")
        ...
        (B.initArc = function () {
            ...
            ((a.arcs = a.main
                .select("." + f.chart)
                .append("g")
                .attr("class", f.chartArcs)
                .attr("transform", a.getTranslate("arc"))),
                a.arcs
                    .append("text")
                    .attr("class", f.chartArcsTitle)
                    .style("text-anchor", "middle")
                    .text(a.getArcTitle()));
        }),
        (B.redrawArc = function (a, b, c) {
            ...
            ((d = i
                ...
                .style("cursor", function (a) {
                    return h.interaction_enabled &&
                        h.data_selection_isselectable(a)
                        ? "pointer"
                        : null;
                })
                .each(function (a) {
                    (e.isGaugeType(a.data) &&
                        (a.startAngle = a.endAngle = h.gauge_startingAngle),
                        (this._current = a));
                }),
                d
                        ...
                        h.interaction_enabled
                            ? function (a) {
                                  var b,
                                      c = e.updateAngle(a);
                                  c &&
                                      ((b = [e.convertToArcData(c)]),
                                      e.showTooltip(b, this));
                              }
                            : null,
                    )
                    .on(
                    ...
                    .attrTween("d", function (a) {
                        ...
                        return c
                            ? (isNaN(this._current.startAngle) &&
                              ...
                              (b = g.interpolate(this._current, c)),
                              (this._current = b(0)),
                              function (c) {
                                  var d = b(c);
                ...
                e.hasType("gauge") &&
                    (e.arcs
                        .select("." + f.chartArcsBackground)
                        .attr("d", function () {
                            var a = {
                                data: [{ value: h.gauge_max }],
                    ...
                    e.arcs
                        .select("." + f.chartArcsGaugeUnit)
                        .attr("dy", ".75em")
                        .text(h.gauge_label_show ? h.gauge_units : ""),
                    e.arcs
                        .select("." + f.chartArcsGaugeMin)
                        .attr(
                            "dx",
                            -1 *
                                (e.innerRadius +
                                    (e.radius - e.innerRadius) /
                                        (h.gauge_fullCircle ? 1 : 2)) +
                                "px",
                        )
                        .attr("dy", "1.2em")
                        .text(
                            h.gauge_label_show
                                ? e.textForGaugeMinMax(h.gauge_min, !1)
                                : "",
                        ),
                    e.arcs
                        .select("." + f.chartArcsGaugeMax)
                        .attr(
                            "dx",
                            e.innerRadius +
                                (e.radius - e.innerRadius) /
                        ...
                        .text(
                            h.gauge_label_show
                                ? e.textForGaugeMinMax(h.gauge_max, !0)
                                : "",
                        )));
        }),
        (B.initGauge = function () {
            var a = this.arcs;
            this.hasType("gauge") &&
                (a.append("path").attr("class", f.chartArcsBackground),
                a
                    .append("text")
                    .attr("class", f.chartArcsGaugeUnit)
                    .style("text-anchor", "middle")
                    .style("pointer-events", "none"),
                a
                    .append("text")
                    .attr("class", f.chartArcsGaugeMin)
                    .style("text-anchor", "middle")
                    .style("pointer-events", "none"),
                a
                    .append("text")
                    .attr("class", f.chartArcsGaugeMax)
                    .style("text-anchor", "middle")
                    .style("pointer-events", "none"));
        }),
        ...
        (B.classArc = function (a) {
            return (
                this.classShape(a.data) + this.generateClass(f.arc, a.data.id)
            );
        }),
        (B.classArcs = function (a) {
            return (
                this.classShapes(a.data) + this.generateClass(f.arcs, a.data.id)
            );
        }),
        ...
        (B.classFocused = function (a) {
            return (
                " " +
                (this.focusedTargetIds.indexOf(a.id) >= 0 ? f.focused : "")
            );
        }),
        (B.classDefocused = function (a) {
            return (
                " " +
                (this.defocusedTargetIds.indexOf(a.id) >= 0 ? f.defocused : "")
            );
        }),
        ...
        (B.convertUrlToData = function (a, b, c, d, e) {
            ...
            (c &&
                ...
                h.get(function (a, b) {
                    ...
                    ((c =
                        "json" === g
                            ? f.convertJsonToData(JSON.parse(h), d)
                            : "tsv" === g
                              ? f.convertTsvToData(h)
                              : f.convertCsvToData(h)),
                        e.call(f, c));
                }));
        }),
        ...
        (B.findValueInJson = function (a, b) {
            for (
                var c = (b = (b = b.replace(/\[(\w+)\]/g, ".$1")).replace(
                        /^\./,
                        "",
                    )).split("."),
                    d = 0;
                                ...
                                return (
                                    ...
                                    void 0 !== i
                                        ? (0 === c &&
                                          ...
                                          -1 ===
                                              (h =
                                                  e.axis_x_categories.indexOf(
                                                      i,
                                                  )) &&
                                              ((h = e.axis_x_categories.length),
                                              e.axis_x_categories.push(i)))
                                        : (h = d.generateTargetX(i, b, g)),
                                    (void 0 === a[b] ||
                                        d.data.xs[b].length <= g) &&
                                        (h = void 0),
                                    { x: h, value: j, id: f }
                                );
                            })
        ...
        (B.getXValuesOfXKey = function (a, b) {
            var c,
                d = this;
            return (
                (b && u(b) ? d.mapToIds(b) : []).forEach(function (b) {
        ...
        (B.getXValue = function (a, b) {
            var c = this;
            return a in c.data.xs && c.data.xs[a] && k(c.data.xs[a][b])
                ? c.data.xs[a][b]
                : b;
        }),
        ...
        (B.generateTargetX = function (a, b, c) {
            var d = this;
            return d.isTimeSeries()
                ? a
                    ? d.parseDate(a)
                    : d.parseDate(d.getXValue(b, c))
                : d.isCustomX() && !d.isCategorized()
                  ? k(a)
                      ? +a
                      : d.getXValue(b, c)
                  : c;
        ...
        (B.addHiddenTargetIds = function (a) {
            ...
            for (var b = 0; b < a.length; b++)
                this.hiddenTargetIds.indexOf(a[b]) < 0 &&
                    (this.hiddenTargetIds = this.hiddenTargetIds.concat(a[b]));
        }),
        ...
        (B.addHiddenLegendIds = function (a) {
            a = a instanceof Array ? a : new Array(a);
            for (var b = 0; b < a.length; b++)
                this.hiddenLegendIds.indexOf(a[b]) < 0 &&
                    (this.hiddenLegendIds = this.hiddenLegendIds.concat(a[b]));
        }),
        ...
        (B.orderTargets = function (a) {
            ...
            return (
                b &&
                    (a.sort(b),
                    (this.isOrderAsc() || this.isOrderDesc()) && a.reverse()),
                a
            );
        }),
        ...
        (B.hasDataLabel = function () {
            var a = this.config;
            return (
                !("boolean" != typeof a.data_labels || !a.data_labels) ||
                !("object" !== g(a.data_labels) || !u(a.data_labels))
            );
        }),
        ...
        (B.getYDomain = function (a, b, c) {
            var d,
                ...
                z =
                    (o.hasType("bar", r) && p.bar_zerobased) ||
                    (o.hasType("area", r) && p.area_zerobased),
                A = "y2" === b ? p.axis_y2_inverted : p.axis_y_inverted,
                B = o.hasDataLabel() && p.axis_rotated,
                C = o.hasDataLabel() && !p.axis_rotated;
            return (
                (w = k(t) ? t : k(v) ? (w < v ? w : v - 10) : w),
                (x = k(v) ? v : k(t) ? (t < x ? x : t + 10) : x),
                0 === r.length
                    ? "y2" === b
                        ? o.y2.domain()
                        : o.y.domain()
                    : (isNaN(w) && (w = 0),
                      ...
                      (f = g = 0.1 * e),
                      void 0 !== y &&
                          ((x = y + (h = Math.max(Math.abs(w), Math.abs(x)))),
                          (w = y - h)),
                      B
                          ? ((i = o.getDataLabelLength(w, x, "width")),
                            (j = s(o.y.range())),
                            (f +=
                                e *
                                ((l = [i[0] / j, i[1] / j])[1] /
                            ...
                            (g += e * (l[0] / (1 - l[0] - l[1]))))
                          : C &&
                            ((i = o.getDataLabelLength(w, x, "height")),
                            (f += o.axis.convertPixelsToAxisPadding(i[1], e)),
                            (g += o.axis.convertPixelsToAxisPadding(i[0], e))),
                      "y" === b &&
                          u(p.axis_y_padding) &&
                          ((f = o.axis.getPadding(
                              p.axis_y_padding,
        ...
        (B.getXDomainPadding = function (a) {
            ...
            return (
                (c = f.isCategorized()
                    ? 0
                    : f.hasType("bar")
                      ? (b = f.getMaxDataCount()) > 1
                          ? i / (b - 1) / 2
                          : 0.5
                      : 0.01 * i),
                "object" === g(h.axis_x_padding) && u(h.axis_x_padding)
                    ? ((d = k(h.axis_x_padding.left)
                          ? h.axis_x_padding.left
                          : c),
                      (e = k(h.axis_x_padding.right)
                          ? h.axis_x_padding.right
                          : c))
                    : (d = e =
                          "number" == typeof h.axis_x_padding
                              ? h.axis_x_padding
                              : c),
                { left: d, right: e }
            );
        ...
        (B.updateXDomain = function (a, b, c, d, e) {
            ...
            return (
                c &&
                    (f.x.domain(e || f.d3.extent(f.getXDomain(a))),
                ...
                (l.data_selection_enabled &&
                    ((l.zoom_enabled && !k.zoom.altDomain) ||
                        (l.data_selection_multiple &&
                            ...
                            (g = Math.min(b, d)),
                            (h = Math.max(b, d)),
                            (i = l.data_selection_grouped
                                ? k.margin.top
                                : Math.min(c, e)),
                            (j = l.data_selection_grouped
                                ? k.height
                                : Math.max(c, e)),
                            m
                                .select("." + f.dragarea)
                            ...
                            m
                                ...
                                .each(function (a, b) {
                                    ...
                                    s ^ r &&
                                        (p.classed(f.INCLUDED, !r),
                                        p.classed(f.SELECTED, !q),
                                        m.call(k, !q, p, a, b));
                                })))));
        }),
            ...
            a.hasArcType() ||
                (b.data_selection_enabled &&
                    (a.main
                        ...
                        .style("opacity", 0)
                        .remove(),
                    a.main.selectAll("." + f.shape).classed(f.INCLUDED, !1),
                    (a.dragging = !1)));
        }),
        ...
        (B.dataLabelFormat = function (a) {
            ...
            return "function" == typeof b.format
                ? b.format
                : "object" === g(b.format)
                  ? b.format[a]
                      ? !0 === b.format[a]
        ...
        (B.initGrid = function () {
            ...
            ((a.grid = a.main
                ...
                .attr("class", f.grid)),
                b.grid_x_show && a.grid.append("g").attr("class", f.xgrids),
                b.grid_y_show && a.grid.append("g").attr("class", f.ygrids),
                b.grid_focus_show &&
                    a.grid
                        .append("g")
                        .attr("class", f.xgridFocus)
                        .append("line")
                        .attr("class", f.xgridFocus),
                (a.xgrid = c.selectAll([])),
        ...
        (B.initGridLines = function () {
            ...
            ((a.gridLines = a.main
                .append("g")
                .attr("clip-path", a.clipPathForGrid)
                .attr("class", f.grid + " " + f.gridLines)),
                a.gridLines.append("g").attr("class", f.xgridLines),
                a.gridLines.append("g").attr("class", f.ygridLines),
        ...
        (B.updateXGrid = function (a) {
            ...
            ((b.xgridAttr = c.axis_rotated
                ...
                (b.xgrid = b.main
                    ...
                    .selectAll("." + f.xgrid)
                    .data(e)),
                b.xgrid.enter().append("line").attr("class", f.xgrid),
                a ||
        ...
        (B.updateYGrid = function () {
            ...
            ((a.ygrid = a.main
                ...
                .selectAll("." + f.ygrid)
                .data(c)),
                a.ygrid.enter().append("line").attr("class", f.ygrid),
                a.ygrid
        ...
        (B.updateGrid = function (a) {
            ...
            (e.grid.style("visibility", e.hasArcType() ? "hidden" : "visible"),
                g.select("line." + f.xgridFocus).style("visibility", "hidden"),
                h.grid_x_show && e.updateXGrid(),
                (e.xgridLines = g
                    .select("." + f.xgridLines)
                    .selectAll("." + f.xgridLine)
                    .data(h.grid_x_lines)),
                (b = e.xgridLines
                    .enter()
                    .append("g")
                ...
                b
                    ...
                    .attr("transform", h.axis_rotated ? "" : "rotate(-90)")
                ...
                e.xgridLines
                    ...
                    .style("opacity", 0)
                    .remove(),
                h.grid_y_show && e.updateYGrid(),
                (e.ygridLines = g
                    .select("." + f.ygridLines)
                    .selectAll("." + f.ygridLine)
                    .data(h.grid_y_lines)),
                (c = e.ygridLines
                    .enter()
                    .append("g")
                ...
                e.ygridLines
                    ...
                    .transition()
                    .duration(a)
                    .attr("x1", h.axis_rotated ? d : 0)
                    .attr("x2", h.axis_rotated ? d : e.width)
                    .attr("y1", h.axis_rotated ? 0 : d)
                    .attr("y2", h.axis_rotated ? e.height : d)
                    .style("opacity", 1),
                e.ygridLines
                    .select("text")
                    .transition()
            ...
            c.tooltip_show &&
                (b.hasType("scatter") ||
                    ...
                    (e
                        ...
                        .data([d[0]])
                        .attr(c.axis_rotated ? "y1" : "x1", g)
                        .attr(c.axis_rotated ? "y2" : "x2", g),
                    b.smoothLines(e, "grid")));
        }),
        (B.hideXGridFocus = function () {
            this.main
                .select("line." + f.xgridFocus)
                .style("visibility", "hidden");
        }),
        ...
        (B.generateGridData = function (a, b) {
            ...
            if ("year" === a)
                for (
                    d = (c = h.getXDomain())[0].getFullYear(),
                        e = c[1].getFullYear(),
                        g = d;
                    g <= e;
                    g++
                )
                    i.push(new Date(g + "-01-01 00:00:00"));
            else
                (i = b.ticks(10)).length > j &&
        ...
        (B.removeGridLines = function (a, b) {
            ...
            (c.main
                ...
                .remove(),
                b
                    ? (d.grid_x_lines = d.grid_x_lines.filter(g))
                    : (d.grid_y_lines = d.grid_y_lines.filter(g)));
        }),
        (B.initEventRect = function () {
            this.main
                .select("." + f.chart)
                .append("g")
                .attr("class", f.eventRects)
        ...
        (B.redrawEventRect = function () {
            var a,
                ...
                g = c.main
                    ...
                    .classed(f.eventRectsMultiple, e)
                    .classed(f.eventRectsSingle, !e);
            (g.selectAll("." + f.eventRect).remove(),
                (c.eventRect = g.selectAll("." + f.eventRect)),
                e
                ...
                .on("mousemove", function (a) {
                    ...
                    b.dragging ||
                        ...
                        (b.isStepType(a) &&
                            ...
                            c.mouse(this)[0] < b.x(b.getXValue(a.id, g)) &&
                            (g -= 1),
                        (e = b
                            .filterTargetsToShow(b.data.targets)
                            .map(function (a) {
                                return b.addName(
                                    b.getValueOnIndex(a.values, g),
                                );
                            })),
                        d.tooltip_grouped &&
                        ...
                        (!d.tooltip_grouped ||
                            ...
                            b.main
                                .selectAll("." + f.shape + "-" + g)
                                .each(function () {
                                    (c.select(this).classed(f.EXPANDED, !0),
                                        d.data_selection_enabled &&
                                            h.style(
                                                "cursor",
                                                d.data_selection_grouped
                                ...
                                .each(function (a) {
                                    (d.data_selection_enabled &&
                                        ...
                                        d.tooltip_grouped ||
                                            ...
                                            b.showXGridFocus([a]),
                                            d.point_focus_expand_enabled &&
                                                b.expandCircles(g, a.id, !0),
                                            b.expandBars(g, a.id, !0)));
                                }));
                })
                .on("click", function (a) {
                    var e = a.index;
        ...
        (B.generateEventRectsForMultipleXs = function (a) {
            function b() {
                (c.svg.select("." + f.eventRect).style("cursor", null),
                    c.hideXGridFocus(),
                    c.hideTooltip(),
                    c.unexpandCircles(),
                    c.unexpandBars());
            ...
            a.append("rect")
                ...
                .on("mousemove", function () {
                    ...
                    c.dragging ||
                        c.hasArcType(i) ||
                        ((a = d.mouse(this)),
                        (g = c.findClosestFromTargets(i, a)),
                        !c.mouseover ||
                            (g && g.id === c.mouseover.id) ||
                            (e.data_onmouseout.call(c.api, c.mouseover),
                            (c.mouseover = void 0)),
                        g
                            ? ((h = (
                                  c.isScatterType(g) || !e.tooltip_grouped
                                      ? [g]
                                      : c.filterByX(i, g.x)
                              ).map(function (a) {
                                  return c.addName(a);
                              ...
                              e.point_focus_expand_enabled &&
                                  c.expandCircles(g.index, g.id, !0),
                              c.expandBars(g.index, g.id, !0),
                              c.showXGridFocus(h),
                              (c.isBarType(g.id) ||
                                  c.dist(g, a) < e.point_sensitivity) &&
                                  (c.svg
                                      .select("." + f.eventRect)
                                      .style("cursor", "pointer"),
                                  c.mouseover ||
                                      (e.data_onmouseover.call(c.api, g),
                                      (c.mouseover = g))))
                            : b());
                })
                .on("click", function () {
                    var a,
                        b,
                        g = c.filterTargetsToShow(c.data.targets);
                    c.hasArcType(g) ||
                        ((a = d.mouse(this)),
                        (b = c.findClosestFromTargets(g, a)) &&
                            (c.isBarType(b.id) ||
        ...
        (B.opacityForUnfocusedLegend = function (a) {
            return a.classed(f.legendItemHidden) ? null : 0.3;
        }),
        (B.toggleFocusLegend = function (a, b) {
            var c = this;
            ((a = c.mapToTargetIds(a)),
                c.legend
                    .selectAll("." + f.legendItem)
                    .filter(function (b) {
                        return a.indexOf(b) >= 0;
                    })
                    .classed(f.legendItemFocused, b)
                    .transition()
                    .duration(100)
                    .style("opacity", function () {
                        return (
                            b ? c.opacityForLegend : c.opacityForUnfocusedLegend
                        ).call(c, c.d3.select(this));
                    }));
        }),
        ...
        (B.updateLegend = function (a, b, c) {
            function d(a, b) {
                return (
                    x.legendItemTextBox[b] ||
                        (x.legendItemTextBox[b] = x.getTextRect(
                            a.textContent,
                            f.legendItem,
                            a,
                        )),
            ...
            function e(b, c, e) {
                ...
                var g,
                    ...
                    l =
                        k.width +
                        E +
                        (!j || x.isLegendRight || x.isLegendInset ? A : 0) +
                        y.legend_padding,
                    m = k.height + z,
                    n = x.isLegendRight || x.isLegendInset ? m : l,
                    o =
                        x.isLegendRight || x.isLegendInset
                            ? x.getLegendHeight()
                            : x.getLegendWidth();
                (i && ((F = 0), (L = 0), (B = 0), (C = 0)),
                    !y.legend_show || x.isLegendToShow(c)
                        ? ((H[c] = l),
                          (I[c] = m),
                          (!B || l >= B) && (B = l),
                          (!C || m >= C) && (C = m),
                          (h = x.isLegendRight || x.isLegendInset ? C : B),
                          y.legend_equally
            ...
            ((a = a.filter(function (a) {
                return (
                    !(void 0 !== y.data_names[a]) || null !== y.data_names[a]
                );
            })),
                (q = v((b = b || {}), "withTransition", !0)),
                (r = v(b, "withTransitionForTransform", !0)),
                x.isLegendInset &&
                    ((L = y.legend_inset_step ? y.legend_inset_step : a.length),
                    x.updateLegendStep(L)),
                x.isLegendRight
                    ? ((g = function (a) {
                          return B * K[a];
                      }),
                ...
                (p = x.legend
                    ...
                    .style("cursor", "pointer")
                    .on("click", function (a) {
                        y.legend_item_onclick
                            ? y.legend_item_onclick.call(x, a)
                            : x.d3.event.altKey
                              ? (x.api.hide(), x.api.show(a))
                              : (x.api.toggle(a),
                                x.isTargetToShow(a)
                                    ? x.api.focus(a)
                                    : x.api.revert());
                    ...
                    .on("mouseover", function (a) {
                        y.legend_item_onmouseover
                            ? y.legend_item_onmouseover.call(x, a)
                            : (x.d3
                                  .select(this)
                                  .classed(f.legendItemFocused, !0),
                              !x.transiting &&
                                  x.isTargetToShow(a) &&
                                  x.api.focus(a));
                    })
                    .on("mouseout", function (a) {
                        y.legend_item_onmouseout
                            ? y.legend_item_onmouseout.call(x, a)
                            : (x.d3
                                  .select(this)
                                  .classed(f.legendItemFocused, !1),
                              x.api.revert());
                    ...
                    .style("pointer-events", "none")
                    .attr("x", x.isLegendRight || x.isLegendInset ? h : -200)
                    .attr("y", x.isLegendRight || x.isLegendInset ? -200 : k),
                p
                    .append("rect")
                    .attr("class", f.legendItemEvent)
                    .style("fill-opacity", 0)
                    .attr("x", x.isLegendRight || x.isLegendInset ? i : -200)
                    .attr("y", x.isLegendRight || x.isLegendInset ? -200 : l),
                p
                    .append("line")
                    .attr("class", f.legendItemTile)
                    .style("stroke", x.color)
                    .style("pointer-events", "none")
                    .attr("x1", x.isLegendRight || x.isLegendInset ? m : -200)
                    .attr("y1", x.isLegendRight || x.isLegendInset ? -200 : o)
                    .attr("x2", x.isLegendRight || x.isLegendInset ? n : -200)
                    .attr("y2", x.isLegendRight || x.isLegendInset ? -200 : o)
                    .attr("stroke-width", y.legend_item_tile_height),
                (w = x.legend.select("." + f.legendBackground + " rect")),
                x.isLegendInset &&
                    B > 0 &&
                    0 === w.size() &&
                    (w = x.legend
                        .insert("g", "." + f.legendItem)
                        .attr("class", f.legendBackground)
                        .append("rect")),
                (s = x.legend
                    .selectAll("text")
                    .data(a)
                ...
                (q ? s.transition() : s).attr("x", h).attr("y", k),
                (t = x.legend.selectAll("rect." + f.legendItemEvent).data(a)),
                (q ? t.transition() : t)
                    ...
                    .attr("x", i)
                    .attr("y", l),
                (u = x.legend.selectAll("line." + f.legendItemTile).data(a)),
                (q ? u.transition() : u)
                    .style("stroke", x.color)
                    .attr("x1", m)
                    .attr("y1", o)
                ...
                w &&
                    (q ? w.transition() : w)
                        .attr("height", x.getLegendHeight() - 12)
                        .attr("width", B * (L + 1) + 10),
                x.legend
                    .selectAll("." + f.legendItem)
                    .classed(f.legendItemHidden, function (a) {
                        return !x.isTargetToShow(a);
                    }),
                x.updateLegendItemWidth(B),
                x.updateLegendItemHeight(C),
                x.updateLegendStep(L),
                x.updateSizes(),
                x.updateScales(),
                x.updateSvgSize(),
                x.transformAll(r, c),
                (x.legendHasRendered = !0));
        }),
            ...
            return [
                (a ? c.transition() : c)
                    ...
                    .style("fill-opacity", function (a) {
                        return k(a.opacity) ? a.opacity : 0.1;
                    }),
            ];
        }),
        (B.regionX = function (a) {
            var b = this,
                c = b.config,
                d = "y" === a.axis ? b.y : b.y2;
            return "y" === a.axis || "y2" === a.axis
                ? c.axis_rotated && "start" in a
                    ? d(a.start)
                    : 0
                : c.axis_rotated
                  ? 0
                  : "start" in a
                    ? b.x(b.isTimeSeries() ? b.parseDate(a.start) : a.start)
                    : 0;
        }),
        ...
        (B.toggleShape = function (a, b, c) {
            ...
            g.data_selection_enabled &&
                g.data_selection_isselectable(b) &&
                (g.data_selection_multiple ||
                    d.main
                        .selectAll(
                            "." +
                                f.shapes +
                        ...
                        .each(function (a, b) {
                            var c = e.select(this);
                            c.classed(f.SELECTED) &&
                                j(!1, c.classed(f.SELECTED, !1), a, b);
                        }),
                h.classed(f.SELECTED, !i),
                j(!i, h, b, c));
        }),
        (B.initBar = function () {
            this.main
        ...
        (B.updateBar = function (a) {
            ...
            ((b.mainBar = b.main
                ...
                b.mainBar.exit().transition().duration(a).remove());
        }),
        ...
        (B.getBarW = function (a, b) {
            var c = this.config,
                d =
                    "number" == typeof c.bar_width
                        ? c.bar_width
                        : b
                          ? (a.tickInterval() * c.bar_width_ratio) / b
                          : 0;
        ...
        (B.getBars = function (a, b) {
            ...
            return (
                b
                    ? c.main.selectAll(
                          "." + f.bars + c.getTargetSelectorSuffix(b),
                      )
                    : c.main
            ).selectAll("." + f.bar + (k(a) ? "-" + a : ""));
        }),
            ...
            return (
                d.isTargetToShow(b.id)
                    ? "circle" === a.nodeName
                        ...
                        : "path" === a.nodeName &&
                          (c = !e.classed(f.bar) || d.isWithinBar(a))
                    : (c = !1),
                c
            );
        }),
        ...
        (B.updateTargetsForLine = function (a) {
            ...
            ((b = c.main
                ...
                b
                    ...
                    .attr("class", i)
                    .style("cursor", function (a) {
                        return d.data_selection_isselectable(a)
                            ? "pointer"
                            : null;
                    }),
                a.forEach(function (a) {
                    c.main
                        .selectAll(
                            "." +
                                f.selectedCircles +
                                c.getTargetSelectorSuffix(a.id),
                        )
            ...
            if (void 0 !== d)
                for (f = 0; f < d.length; f++)
                    ((u[f] = {}),
                        void 0 === d[f].start
                            ? (u[f].start = a[0].x)
                            : (u[f].start = q.isTimeSeries()
                                  ? q.parseDate(d[f].start)
                                  : d[f].start),
                        void 0 === d[f].end
                            ? (u[f].end = a[a.length - 1].x)
                            : (u[f].end = q.isTimeSeries()
                                  ? q.parseDate(d[f].end)
                                  : d[f].end));
            for (
                o = r.axis_rotated
                ...
                if (
                    ...
                    for (
                        i = q.getScale(
                            ...
                            j = q.getScale(a[f - 1].value, a[f].value),
                            k = b(a[f].x) - b(a[f - 1].x),
                            ...
                            n =
                                ...
                                (m =
                                    2 /
                                    Math.sqrt(Math.pow(k, 2) + Math.pow(l, 2))),
                            g = m;
                        g <= 1;
                        g += n
                    )
        ...
        (B.getCircles = function (a, b) {
            ...
            return (
                b
                    ? c.main.selectAll(
                          "." + f.circles + c.getTargetSelectorSuffix(b),
                      )
                    : c.main
            ).selectAll("." + f.circle + (k(a) ? "-" + a : ""));
        }),
        (B.expandCircles = function (a, b, c) {
            var d = this,
                e = d.pointExpandedR.bind(d);
            (c && d.unexpandCircles(),
                d.getCircles(a, b).classed(f.EXPANDED, !0).attr("r", e));
        }),
        ...
        (B.pointExpandedR = function (a) {
            ...
            return c.point_focus_expand_enabled
                ? l(c.point_focus_expand_r)
                    ? c.point_focus_expand_r(a)
        ...
        (B.getSvgLeft = function (a) {
            var b = this,
                ...
                h = g && d ? g.getBoundingClientRect() : { right: 0 },
        ...
        (B.initBrush = function () {
            ...
            ((a.brush = b.svg.brush().on("brush", function () {
                ...
                (a.brush.update = function () {
                    return (
                        a.context && a.context.select("." + f.brush).call(this),
                        this
                    );
                }),
        ...
        (B.updateTargetsForSubchart = function (a) {
            ...
            e.subchart_show &&
                ...
                (b = d
                    ...
                    .append("g")
                    .attr("class", j),
                b.append("g").attr("class", k),
                d
                    .selectAll("." + f.brush + " rect")
                    .attr(
                        e.axis_rotated ? "width" : "height",
                        e.axis_rotated ? c.width2 : c.height2,
                    ));
        }),
            ...
            return (
                f.config.axis_rotated
                    ...
                    : (d = f.hasType("bar")
                          ...
                          : a[0][0]),
                null === b.value &&
                    (d > f.width ? (d = f.width - g.width) : d < 0 && (d = 4)),
                d
            );
        }),
        ...
        (B.getTooltipSortFunction = function () {
            ...
            if (0 !== b.data_groups.length && void 0 === b.tooltip_order) {
                ...
                return (
                    (a.isOrderAsc() || a.isOrderDesc()) && (c = c.reverse()),
                    function (a, b) {
            ...
            if (n(d) && "asc" === d.toLowerCase())
                return function (a, b) {
                    return e(a) - e(b);
                };
            if (n(d) && "desc" === d.toLowerCase())
                return function (a, b) {
                    return e(b) - e(a);
                };
            if (l(d)) {
                var f = d;
                return (
                    void 0 === b.tooltip_order &&
                        (f = function (a, b) {
                            return d(
                                a ? { id: a.id, values: [a] } : null,
                                b ? { id: b.id, values: [b] } : null,
                            );
                        }),
                    f
                );
        ...
        (B.getTooltipContent = function (a, b, c, d) {
            ...
            for (p && a.sort(p), f = 0; f < a.length; f++)
                if (
                    ...
                    void 0 !==
                        (h = x(
                            o(a[f].value, a[f].ratio, a[f].id, a[f].index, a),
                        )))
                ) {
                    if (null === a[f].name) continue;
                    ((i = x(n(a[f].name, a[f].ratio, a[f].id, a[f].index))),
                        (j = k.levelColor
        ...
        (B.getZoomDomain = function () {
            var a = this,
                ...
                c = a.d3;
            return [
                c.min([a.orgXDomain[0], b.zoom_x_min]),
                c.max([a.orgXDomain[1], b.zoom_x_max]),
            ];
        }),
    ...
    (function () {
        ...
        function M(a) {
            function b() {
                var b = this.ownerDocument,
                    c = this.namespaceURI;
                return c === Bg && b.documentElement.namespaceURI === Bg
                    ? b.createElement(a)
        ...
        function W(a, b) {
            ...
            return function (a) {
                var b = this,
                    d = a.relatedTarget;
                (d && (d === b || 8 & d.compareDocumentPosition(b))) ||
                    c.call(b, a);
            };
        }
        function X(c) {
            ...
            if (
                (null == Fg &&
                    (Fg = !("onselectstart" in c) && u(c.style, "userSelect")),
                Fg)
            ) {
                var g = a(c).style,
                    h = g[Fg];
        ...
        function ka(a, b, c) {
            return (
                isNaN(a) && (a = 0),
                isNaN(b) && (b = 0),
                new la(c, Math.cos((a *= Og)) * b, Math.sin(a) * b)
            );
        }
        function la(a, b, c) {
        ...
        function na(a, b, c) {
            return a > 0
                ? new ja(Math.atan2(c, b) * Pg, Math.sqrt(b * b + c * c), a)
                : new ja(NaN, NaN, a);
        }
        function oa(a) {
        ...
        function xa(a, b, c) {
            ...
            var d = pa((0.4124564 * a + 0.3575761 * b + 0.1804375 * c) / Xg),
                e = pa((0.2126729 * a + 0.7151522 * b + 0.072175 * c) / Yg);
            return la(
                116 * e - 16,
                500 * (d - e),
                200 *
                    (e -
                        pa(
                            (0.0193339 * a + 0.119192 * b + 0.9503041 * c) / Zg,
                        )),
            );
        }
        function ya(a) {
        ...
        function Fa(a, b, c) {
            ...
            return (
                ch ? (ch.n = f) : (bh = f),
                (ch = f),
                dh || ((eh = clearTimeout(eh)), (dh = 1), fh(Ga)),
                f
            );
        }
        function Ga() {
            var a = Ha(),
                b = Ia() - a;
            b > 24
                ? (isFinite(b) && (clearTimeout(eh), (eh = setTimeout(Ga, b))),
                  (dh = 0))
                : ((dh = 1), fh(Ga));
        }
        function Ha() {
            for (var a = Date.now(), b = bh; b; )
                (a >= b.t && b.c(a - b.t) && (b.c = null), (b = b.n));
            return a;
        }
        function Ia() {
            for (var a, b = bh, c = 1 / 0; b; )
                b.c
                    ? (b.t < c && (c = b.t), (b = (a = b).n))
                    : (b = a ? (a.n = b.n) : (bh = b.n));
            return ((ch = a), c);
        ...
        function Qa(a) {
            ...
            function d(a, b, c) {
                ...
                return d
                    ? ((a.w = x.get(d[0].toLowerCase())), c + d[0].length)
                    : -1;
            }
            function e(a, b, c) {
                u.lastIndex = 0;
                ...
                return d
                    ? ((a.w = v.get(d[0].toLowerCase())), c + d[0].length)
                    : -1;
            }
            function f(a, b, c) {
                A.lastIndex = 0;
                ...
                return d
                    ? ((a.m = B.get(d[0].toLowerCase())), c + d[0].length)
                    : -1;
            }
            function g(a, b, c) {
                y.lastIndex = 0;
                ...
                return d
                    ? ((a.m = z.get(d[0].toLowerCase())), c + d[0].length)
                    : -1;
            }
            function h(a, b, d) {
        ...
        function Kb(a, b) {
            return (
                ((a = a.x)[0] < 0 ? a[1] - Ng - Ig : Ng - a[1]) -
                ((b = b.x)[0] < 0 ? b[1] - Ng - Ig : Ng - b[1])
            );
        }
        function Lb(a) {
            var b,
            ...
            return function (h) {
                function i(a) {
                    for (var b = 0, c = q.length, d = a[1], e = 0; c > e; ++e)
                        for (
                            var f, g = 1, h = q[e], i = h.length, j = h[0];
                            i > g;
                            ++g
                        )
                            ((f = h[g]),
                ...
                function o(a, b) {
                    ((a = Math.max(-Jh, Math.min(Jh, a))),
                        (b = Math.max(-Jh, Math.min(Jh, b))));
                    var c = k(a, b);
                    if ((q && r.push([a, b]), y))
                        ((s = a),
                            (t = b),
        ...
        function oc(a, b) {
            ...
            return function (e, f, g, h) {
                ...
                for (var j, k = e; g > 0 ? k > f : f > k; k -= i)
                    h.point(
                        (j = vb([c, -d * Math.cos(k), -d * Math.sin(k)]))[0],
                        j[1],
                    );
            };
        }
            ...
            var e = Math.cos(b),
                ...
                o = m
                    ? function (a) {
                          ...
                          return [
                              Math.atan2(e, d) * Pg,
                              Math.atan2(g, Math.sqrt(d * d + e * e)) * Pg,
                          ];
                      }
                    : function () {
                          return [a * Pg, b * Pg];
        ...
        function vc() {
            function a(a, e) {
                ...
                ((Th += Math.atan2(
                    Math.sqrt(
                        (h = g * Math.sin(h)) * h + (h = d * f - c * g * i) * h,
                    ),
                    c * f + d * g * i,
                )),
                    (b = a),
        ...
        function xc(a, b) {
            ...
            return f
                ? ((c.invert = function (a, b) {
                      ...
                      return [
                          Math.atan2(a, c) / f,
                          2 * Math.atan(Math.pow(g / d, 1 / f)) - Ng,
                      ];
                  }),
                  c)
                : zc;
        ...
        function Mc(a) {
            ...
            for (
                var i = f;
                i.circle && rg(c - i.circle.x) < Ig && rg(d - i.circle.cy) < Ig;
            )
                ((f = i.P), h.unshift(i), Lc(i), (i = f));
            (h.unshift(i), Vc(i));
            for (
                var j = g;
                j.circle && rg(c - j.circle.x) < Ig && rg(d - j.circle.cy) < Ig;
            )
        ...
        function Wc(a) {
            for (
                ...
                ((b = c[e]),
                    (!Xc(b, a) ||
                        !d(b) ||
                        (rg(b.a.x - b.b.x) < Ig && rg(b.a.y - b.b.y) < Ig)) &&
        ...
        function Zc(a, b, c, d) {
            ...
            return (
                ...
                c && _c(e, a, b, c),
                d && _c(e, b, a, d),
                ai[a.i].edges.push(new ad(e, a, b)),
                ai[b.i].edges.push(new ad(e, b, a)),
                e
            );
        }
        function $c(a, b, c) {
        ...
        function gd(a, b) {
            var c,
                ...
                f = a.sort(hd).pop();
            for (
                _h = [], ai = new Array(a.length), bi = new bd(), di = new bd();
                ;
            )
                if (
                    ((e = ci),
                    ...
                    ((f.x === c && f.y === d) ||
                        ((ai[f.i] = new Qc(f)), Nc(f), (c = f.x), (d = f.y)),
                        (f = a.pop()));
                else {
                    if (!e) break;
                    Mc(e.arc);
        ...
        function rd(a, b) {
            var c,
                d,
                e,
                f = (hi.lastIndex = ii.lastIndex = 0),
                g = -1,
                h = [],
                i = [];
            for (a += "", b += ""; (c = hi.exec(a)) && (d = ii.exec(b)); )
                ((e = d.index) > f &&
        ...
        function Ed(a, b) {
            ...
            return (
                ...
                arguments.length
                    ? (c = (b / Lg) * Math.asin(1 / a))
                    : ((a = 1), (c = b / 4)),
                function (d) {
                    return (
                        1 +
                        a * Math.pow(2, -10 * d) * Math.sin(((d - c) * Lg) / b)
                    );
                }
            );
        }
        ...
        function Ld(a) {
            ...
            (b[0] * c[1] < c[0] * b[1] &&
                ((b[0] *= -1), (b[1] *= -1), (d *= -1), (e *= -1)),
                (this.rotate =
                    (d ? Math.atan2(b[1], b[0]) : Math.atan2(-c[0], c[1])) *
                    Pg),
        ...
        function Xd(a) {
            for (
                var b = a.source, c = a.target, d = Zd(b, c), e = [b];
                b !== d;
            )
                ((b = b.parent), e.push(b));
        ...
        function bf(a, b) {
            var c = af(b[2]);
            return a in ui
                ? Math.abs(c - af(Math.max(rg(b[0]), rg(b[1])))) + +("e" !== a)
                : c - 2 * ("%" === a);
        }
        function cf(a, b, c, d) {
            function e(a) {
        ...
        function ff(a, b) {
            function c(c) {
                return f[
                    ((e.get(c) ||
                        ("range" === b.t ? e.set(c, a.push(c)) : NaN)) -
                        1) %
                        f.length
                ];
            }
            ...
            return (
                ...
                (c.rangeRoundBands = function (e, h, i) {
                    ...
                    return (
                        (f = d(
                            k + Math.round((l - k - (a.length - h) * m) / 2),
                            m,
                        )),
                        j && f.reverse(),
                        (g = Math.round(m * (1 - h))),
        ...
        function sf(a, b, c, d, e) {
            var f = a[0] - b[0],
                ...
                v =
                    (0 > r ? -1 : 1) *
                    Math.sqrt(Math.max(0, t * t * s - u * u)),
                w = (u * r - q * v) / s,
                x = (-u * q - r * v) / s,
                y = (u * r + q * v) / s,
                z = (-u * q + r * v) / s,
        ...
        function Af(a, b) {
            return a.length < 3
                ...
                : a[0] +
                      Cf(
                          (a.push(a[0]), a),
                          Df([a[a.length - 2]].concat(a, [a[1]]), b),
                      );
        }
        function Bf(a, b) {
        ...
        function Cf(a, b) {
            if (
                b.length < 1 ||
                (a.length != b.length && a.length != b.length + 2)
            )
                return uf(a);
        ...
        function Ff(a) {
            ...
            for (
                var b, c = [], d = -1, e = a.length, f = [0], g = [0];
                ++d < 3;
            )
                ((b = a[d]), f.push(b[0]), g.push(b[1]));
            for (c.push(If(Fi, f) + "," + If(Fi, g)), --d; ++d < e; )
                ((b = a[d]),
                    f.shift(),
                    f.push(b[0]),
                    g.shift(),
        ...
        function Gf(a) {
            for (
                var b, c, d = -1, e = a.length, f = e + 4, g = [], h = [];
                ++d < 4;
            )
                ((c = a[d % e]), g.push(c[0]), h.push(c[1]));
            for (b = [If(Fi, g), ",", If(Fi, h)], --d; ++d < f; )
                ((c = a[d % e]),
                    g.shift(),
                    g.push(c[0]),
                    h.shift(),
        ...
        function Mf(a) {
            for (
                var b, c, d, e, f = [], g = Lf(a), h = -1, i = a.length - 1;
                ++h < i;
            )
                ((b = Kf(a[h], a[h + 1])),
                    rg(b) < Ig
        ...
        function Wf(a) {
            return function () {
                ...
                (b = this[a]) &&
                    ...
                    (b.active += 0.5),
                    d.event &&
                        d.event.interrupt.call(this, this.__data__, d.index));
            };
        }
        function Xf(a, b, c) {
            ...
            (Ag.selectAll = function (a) {
                ...
                for (var e = -1, f = this.length; ++e < f; )
                    for (var g = this[e], h = -1, i = g.length; ++h < i; )
                        (c = g[h]) &&
                            (d.push((b = jg(a.call(c, c.__data__, h, e)))),
                            (b.parentNode = c));
                return B(d);
            }));
        ...
        ((hg.ns = {
            ...
            qualify: function (a) {
                ...
                return (
                    b >= 0 &&
                        "xmlns" !== (c = a.slice(0, b)) &&
                        (a = a.slice(b + 1)),
                    Cg.hasOwnProperty(c) ? { space: Cg[c], local: a } : a
                );
            },
        }),
            ...
            (Ag.data = function (a, b) {
                function c(a, c) {
                    ...
                    if (b) {
                        ...
                        for (d = -1; ++d < g; )
                            (e = a[d]) &&
                                (r.has((q = b.call(e, e.__data__, d)))
                                    ? (p[d] = e)
                                    : r.set(q, e),
                                (s[d] = q));
                        for (d = -1; ++d < l; )
                            ((e = r.get((q = b.call(c, (f = c[d]), d))))
                                ? !0 !== e && ((n[d] = e), (e.__data__ = f))
                                : (o[d] = O(f)),
                                r.set(q, !0));
                        for (d = -1; ++d < g; )
                            d in s && !0 !== r.get(s[d]) && (p[d] = a[d]);
                    } else {
                        for (d = -1; ++d < m; )
                            ((e = a[d]),
                                (f = c[d]),
            ...
            (Ag.order = function () {
                for (var a = -1, b = this.length; ++a < b; )
                    for (
                        var c, d = this[a], e = d.length - 1, f = d[e];
                        --e >= 0;
                    )
                        (c = d[e]) &&
                            (f &&
        ...
        ((hg.selection.enter = S),
            ...
            (Dg.select = function (a) {
                for (
                    var b, c, d, e, f, g = [], h = -1, i = this.length;
                    ++h < i;
                ) {
                    ((d = (e = this[h]).update),
                        g.push((b = [])),
                    ...
                    for (var j = -1, k = e.length; ++j < k; )
                        (f = e[j])
                            ? (b.push(
                                  (d[j] = c =
                                      a.call(e.parentNode, f.__data__, j, h)),
                              ),
            ...
            (Dg.insert = function (a, b) {
                return (
                    arguments.length < 2 && (b = T(this)),
                    Ag.insert.call(this, a, b)
                );
            }),
            (hg.select = function (b) {
                ...
                return (
                    "string" == typeof b
                        ? ((c = [xg(b, kg)]),
                          (c.parentNode = kg.documentElement))
            ...
            (hg.selectAll = function (a) {
                ...
                return (
                    "string" == typeof a
                        ? ((b = jg(yg(a, kg))),
                          (b.parentNode = kg.documentElement))
        ...
        ((hg.touch = function (a, b, c) {
            if (
                (arguments.length < 3 && ((c = b), (b = z().changedTouches)), b)
            )
                ...
                function c(a, b, c, f, g) {
                    return function () {
                        ...
                        var j,
                            k = this,
                            l =
                                hg.event.target.correspondingElement ||
                                hg.event.target,
                            m = k.parentNode,
                            n = d.of(k, arguments),
                            o = 0,
        ...
        ((hg.interpolateZoom = function (a, b) {
            ...
            (hg.behavior.zoom = function () {
                ...
                function j(a) {
                    (h(),
                        a({ type: "zoom", scale: z.k, translate: [z.x, z.y] }));
                }
                function k(a) {
        ...
        ((Vg.brighter = function (a) {
            return new ja(
                this.h,
                this.c,
                Math.min(100, this.l + Wg * (arguments.length ? a : 1)),
            );
        }),
            (Vg.darker = function (a) {
                return new ja(
                    this.h,
                    this.c,
                    Math.max(0, this.l - Wg * (arguments.length ? a : 1)),
                );
            }),
            (Vg.rgb = function () {
        ...
        ((hg.timer = function () {
            ...
            (hg.round = function (a, b) {
                return b
                    ? Math.round(a * (b = Math.pow(10, b))) / b
                    : Math.round(a);
            }));
        var gh = [
            "y",
        ...
        hg.formatPrefix = function (a, b) {
            ...
            return (
                (a = +a) &&
                    ...
                    (c = Math.max(
                        -24,
                        Math.min(24, 3 * Math.floor((c - 1) / 3)),
                    ))),
                gh[8 + c / 3]
            );
        };
        ...
        ((jh.year = Oa(
            ...
            (jh.years = jh.year.range),
            (jh.years.utc = jh.year.utc.range),
            (jh.day = Oa(
                function (a) {
                    var b = new kh(2e3, 0);
                    return (
            ...
            (jh.days = jh.day.range),
            (jh.days.utc = jh.day.utc.range),
            (jh.dayOfYear = function (a) {
                var b = jh.year(a);
                return Math.floor(
                    (a -
                        b -
                        6e4 * (a.getTimezoneOffset() - b.getTimezoneOffset())) /
                        864e5,
                );
            }),
            [
                ...
                var c = (jh[a] = Oa(
                    ...
                    function (a) {
                        ...
                        return (
                            Math.floor((jh.dayOfYear(a) + ((c + b) % 7)) / 7) -
                            (c !== b)
                        );
                    },
                ));
                ((jh[a + "s"] = c.range),
                    (jh[a + "s"].utc = c.utc.range),
                    (jh[a + "OfYear"] = function (a) {
                        var c = jh.year(a).getDay();
                        return Math.floor(
                            (jh.dayOfYear(a) + ((c + b) % 7)) / 7,
                        );
                    }));
            }),
            (jh.week = jh.sunday),
            (jh.weeks = jh.sunday.range),
            (jh.weeks.utc = jh.sunday.utc.range),
            (jh.weekOfYear = jh.sundayOfYear));
        var mh = { "-": "", _: " ", 0: "0" },
            nh = /^\s*\d+/,
            oh = /^%/;
        ...
        ((hg.format = ph.numberFormat),
            ...
            (jb.prototype = {
                ...
                add: function (a) {
                    (kb(a, this.t, qh),
                        kb(qh.s, this.s, this),
                        this.s ? (this.t += qh.t) : (this.s = qh.t));
                },
                reset: function () {
                    this.s = this.t = 0;
                },
        ...
        var th,
            ...
            vh = {
                ...
                polygonEnd: function () {
                    var a = 2 * uh;
                    ((th += 0 > a ? 4 * Kg + a : a),
                        (vh.lineStart = vh.lineEnd = vh.point = v));
                },
            };
        ((hg.geo.bounds = (function () {
            ...
            (hg.geo.centroid = function (a) {
                ((wh = xh = yh = zh = Ah = Bh = Ch = Dh = Eh = Fh = Gh = 0),
                    hg.geo.stream(a, Hh));
                var b = Eh,
                    c = Fh,
                    d = Gh,
                ...
                return Jg > e &&
                    ...
                    (c = Ch),
                    (d = Dh),
                    Ig > xh && ((b = yh), (c = zh), (d = Ah)),
                    (e = b * b + c * c + d * d),
                    Jg > e)
                    ? [NaN, NaN]
                    : [Math.atan2(c, b) * Pg, ba(d / Math.sqrt(e)) * Pg];
            }));
        var wh,
            xh,
            yh,
        ...
        var Kh,
            ...
            Qh = {
                ...
                polygonEnd: function () {
                    ((Qh.lineStart = Qh.lineEnd = Qh.point = v),
                        (Kh += rg(Lh / 2)));
                },
            },
            Rh = {
        ...
        ((hg.geo.path = function () {
            function a(a) {
                return (
                    a &&
                        ("function" == typeof h &&
                            f.pointRadius(+h.apply(this, arguments)),
                        (g && g.valid) || (g = e(f)),
                        hg.geo.stream(a, g)),
                    f.result()
                );
            ...
            return (
                ...
                (a.centroid = function (a) {
                    return (
                        (yh = zh = Ah = Bh = Ch = Dh = Eh = Fh = Gh = 0),
                        hg.geo.stream(a, e(Sh)),
                        Gh
                            ? [Eh / Gh, Fh / Gh]
                            : Dh
                              ? [Bh / Dh, Ch / Dh]
        ...
        (($h.area = function () {
            for (
                var a, b = -1, c = this.length, d = this[c - 1], e = 0;
                ++b < c;
            )
            ...
            ($h.centroid = function (a) {
                var b,
                    ...
                    h = this[e - 1];
                for (
                    arguments.length || (a = -1 / (6 * this.area()));
                    ++d < e;
                )
                    ((b = h),
                        (h = this[d]),
        ...
        var mi = { a: 1, b: 0, c: 0, d: 1, e: 0, f: 0 };
            ...
            (hg.layout.force = function () {
                ...
                return (
                    (i.tick = function () {
                        ...
                        if (o)
                            for (
                                ce((b = hg.geom.quadtree(t)), e, h), d = -1;
                                ++d < w;
                            )
                    ...
                    (i.start = function () {
                        ...
                        var b,
                            ...
                            p = k[1];
                        for (b = 0; e > b; ++b)
                            (((d = t[b]).index = b), (d.weight = 0));
                        for (b = 0; j > b; ++b)
                            ((d = u[b]),
                                "number" == typeof d.source &&
                                    (d.source = t[d.source]),
                                "number" == typeof d.target &&
                                    (d.target = t[d.target]),
                                ++d.source.weight,
                                ++d.target.weight);
                        for (b = 0; e > b; ++b)
        ...
        hg.layout.stack = function () {
            function a(h, i) {
                ...
                for (o = 0; r > o; ++o)
                    for (
                        e.call(a, j[0][o], (p = q[o]), k[0][o][1]), n = 1;
                        m > n;
                        ++n
                    )
            ...
            return (
                ...
                (a.order = function (b) {
                    return arguments.length
                        ? ((c = "function" == typeof b ? b : ri.get(b) || ne),
                          a)
                        : c;
                }),
                (a.offset = function (b) {
                    return arguments.length
                        ? ((d = "function" == typeof b ? b : si.get(b) || oe),
                          a)
                        : d;
                }),
                (a.x = function (b) {
            ...
            si = hg.map({
                ...
                wiggle: function (a) {
                    ...
                    for (n[0] = i = j = 0, c = 1; m > c; ++c) {
                        ...
                        for (
                            b = 0, f = 0, h = l[c][0] - l[c - 1][0];
                            k > b;
                            ++b
                        ) {
                            for (
                                d = 0,
                                    g = (a[b][c][1] - a[b][c - 1][1]) / (2 * h);
                                b > d;
                                ++d
                            )
        ...
        ((hg.layout.histogram = function () {
            ...
            (hg.layout.tree = function () {
                ...
                function b(a) {
                    for (
                        ...
                        for (
                            var e, f = b.children, g = 0, h = f.length;
                            h > g;
                            ++g
                        )
                            d.push(
                ...
                function c(b) {
                    ...
                    if (d && d.length) {
                        var f,
                            ...
                            i = [];
                        for (
                            a(h, (g.dx * g.dy) / b.value), i.area = 0;
                            (f = h.pop());
                        )
                            (i.push(f),
                                (i.area += f.area),
                ...
                normal: function (a, b) {
                    ...
                    return (
                        ...
                        function () {
                            ...
                            return (
                                a + b * c * Math.sqrt((-2 * Math.log(e)) / e)
                            );
                        }
                    );
                },
            ...
            (hg.scale = {}));
        var ti = { floor: s, ceil: s };
        hg.scale.linear = function () {
            return We([0, 1], [0, 1], sd, !1);
        };
        var ui = { s: 1, g: 1, p: 1, r: 1, e: 1 };
        ...
        ((hg.svg.line.radial = function () {
            ...
            (hg.svg.symbol = function () {
                function a(a, d) {
                    return (Gi.get(b.call(this, a, d)) || Vf)(
                        c.call(this, a, d),
                    );
                }
                var b = Uf,
        ...
        ((Mi.call = Ag.call),
            ...
            (hg.transition.prototype = Mi),
            (Mi.select = function (a) {
                var b,
                    c,
                    d,
                    e = this.id,
            ...
            (Mi.each = function (a, b) {
                ...
                if (arguments.length < 2) {
                    ...
                    R(this, function (e) {
                        ...
                        (
                            f.event ||
                            (f.event = hg.dispatch("start", "end", "interrupt"))
                        ).on(a, b);
                    });
                return this;
            }),
        ...
        var Oi = "bottom",
            Pi = { top: 1, right: 1, bottom: 1, left: 1 };
            ...
            function f() {
                ...
                function q() {
                    ...
                    (u && ((a[0] += u[0]), (a[1] += u[1])),
                        ...
                        b &&
                            (c(z),
                            x({ type: "brush", mode: D ? "move" : "resize" })));
                }
                function r(a, b, c) {
                    var d,
                        e,
                    ...
                    return (
                        D && ((i -= k), (j -= q + k)),
                        (d = (c ? o : n)
                            ? Math.max(i, Math.min(j, a[c]))
                            : a[c]),
                        D
                            ? (e = (d += k) + q)
                            : (t &&
                                  (k = Math.max(i, Math.min(j, 2 * t[c] - d))),
                              d > k ? ((e = d), (d = k)) : (e = k)),
                        p[0] != d || p[1] != e
                            ? (c ? (h = null) : (g = null),
                              (p[0] = d),
        ...
        ((Si.iso =
            ...
            (jh.seconds = jh.second.range),
            (jh.seconds.utc = jh.second.utc.range),
            (jh.minute = Oa(
                function (a) {
            ...
            (jh.minutes = jh.minute.range),
            (jh.minutes.utc = jh.minute.utc.range),
            (jh.hour = Oa(
                function (a) {
            ...
            (jh.hours = jh.hour.range),
            (jh.hours.utc = jh.hour.utc.range),
            (jh.month = Oa(
                function (a) {
            ...
            (jh.months = jh.month.range),
            (jh.months.utc = jh.month.utc.range));
        var Vi = [
