    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                <li>
                    <div class="user-info">
                        <a class="image" href="profile.html"><img src="assets/images/unnamed.jpg"
                                alt="User"></a>
                        <div class="detail">
                            <h4>JAGA RABARI</h4>
                ...
                <li class="open_top active open"><a href="javascript:void(0);" class="menu-toggle"><i
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-12">
                        <div class="card mcard_3">
                            <div class="body">
                                <a href="profile"><img src="assets/images/unnamed.jpg" class="rounded-circle shadow "
                                        alt="profile-image"></a>
                                <h4 class="m-t-10">JAGA RABARI</h4>
                                <div class="row">
                                    <div class="col-12">
