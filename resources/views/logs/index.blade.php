            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            <li class="active"><a href="normal-tables">Normal Tables</a></li>
                            ...
                            <table class="table table-hover mb-0 c_list c_table">
                                <thead>
                                    <tr style="border-bottom: 2px solid #dddddd;">
                                        ...
                                        <th style="border-bottom: 2px solid #dddddd;">PASSWOED</th>
                                        <th style="border-bottom: 2px solid #dddddd;">CREATED DATE</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($logs as $log)
